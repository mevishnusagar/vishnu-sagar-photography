...
export async function getStaticPaths() {
    ...
    const paths = services.results.map((service) => ({
        params: { serviceType: service.uid }
    }));
    console.log(paths)
...
export async function getStaticProps({ params }) {
    const prismicData = await Client().getByUID("services", params.serviceType);
...
function ServiceType({ images_Data, meta_title, meta_keywords, meta_ogImage }) {
    ...
    return (
        <div>
            <Head>
                ...
                {/* <metaTags meta_title={meta_title} pageUrl={pageUrl} meta_keywords={meta_keywords} meta_ogImage={meta_ogImage} /> */}
            </Head>
